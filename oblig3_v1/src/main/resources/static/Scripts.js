...
function resetList(){
    const ok = confirm("Are you sure you wanna delete all tickets")
    if(ok){
        $.ajax({
                url: "/slettAlle",
                method: "delete",
                success: function (result){
                    console.log("All Tickets have been deleted")
                    printOutOrders();
                }
            }
...
function giveMeExcuse(){
    ...
    function deleteTicket(id) { // Sletter en bestemt billett ved bruk av billett id i BillettController
        $.ajax({
            url: "/slettEnkel/"+id,
            method: "delete",
            success: function (result) {
                console.log("Billett med id: "+result+" ble slettet.");
                printOutOrders();
            }
        });
    }
